...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 active:scale-[0.97] select-none",
  {
    variants: {
      variant: {
        primary:
          "bg-primary text-primary-foreground shadow-md shadow-primary/20 hover:brightness-110 hover:shadow-lg hover:shadow-primary/25 hover:-translate-y-0.5",
        gradient:
          "text-white shadow-[0_10px_34px_-10px_rgba(124,92,240,0.55)] hover:-translate-y-0.5 hover:shadow-[0_16px_44px_-10px_rgba(124,92,240,0.7)] bg-[linear-gradient(125deg,#6a4ff0_0%,#c0497f_52%,#cf6a2e_100%)] bg-[length:170%_170%] hover:bg-[position:100%_0]",
        secondary:
